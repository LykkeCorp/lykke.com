...
export class FeesAndLimits extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      assetFees: [],
      assetFeesLoading: false
    };
  }

  async componentDidMount() {
    this.setState({ assetFeesLoading: true });
    ...
    this.setState({ assetFees, assetFeesLoading: false });
  }

  render() {
    const { assetFees, assetFeesLoading } = this.state;
    return (
        ...
        <Row className="justify-content-center">
          <Col xs={12} md={8}>
            <FeesAndLimitsWrapper className="text-container">
              ...
              <p>
                Deposit amounts are based on the approved level for your
                account. Please review the levels you may have after signing up
                for a Lykke account:
              </p>
              <List>
                <li>Beginner</li>
              ...
              <p>
                Requirements: NO third party deposits or withdrawals are
                accepted. Customers can use only their personal bank accounts or
                credit cards.
              </p>
              ...
              <List>
                <li>
                  Lykke does not charge any fees for withdrawal operations.
                  Please note that the receiving or intermediary banks might
                  charge a fee for the operation.
                </li>
                <li>
